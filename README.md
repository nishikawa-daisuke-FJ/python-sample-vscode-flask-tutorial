[![Build Status](https://dev.azure.com/fj-arch-tech-SM/sandbox/_apis/build/status%2Fnishikawa-daisuke-FJ.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/fj-arch-tech-SM/sandbox/_build/latest?definitionId=4&branchName=main)
